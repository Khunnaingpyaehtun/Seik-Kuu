...
const Hero: React.FC<HeroProps> = ({ t }) => {
  return (
    <section className="min-h-[60vh] md:min-h-[70vh] flex items-center pt-2 md:pt-4 px-4 md:px-6 relative overflow-hidden text-left">
      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
        <div className="space-y-4 md:space-y-6">
          <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-slate-900/80 border border-cyan-500/30 text-cyan-400 text-[10px] font-bold tracking-widest uppercase shadow-[0_0_20px_rgba(34,211,238,0.15)] backdrop-blur-md mt-4">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-white uppercase py-1 md:py-2 tracking-tight">
            <span className="tech-gradient block drop-shadow-lg">{t('hero-h1-1')}</span>
          </h1>
          
          <p className="text-slate-300 max-w-2xl text-base md:text-xl lg:text-2xl leading-relaxed font-medium border-l-2 border-slate-700 pl-6">
            {t('hero-p')}
          </p>
        ...
        <div className="relative flex justify-center items-center h-[300px] sm:h-[400px] lg:h-[500px]">
          <div className="relative w-64 h-64 sm:w-80 lg:w-96 flex items-center justify-center">
