    ...
    <section id="work" className="container mx-auto px-4 md:px-6 py-20 scroll-mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        {workData.map((w, index) => (
          <div key={index} className="glass-panel p-8 rounded-3xl border border-white/5 hover:bg-white/5 transition-all group">
            <div className="text-4xl mb-4 group-hover:scale-110 transition-transform">{w.icon}</div>
            <h4 className="text-xl font-bold text-white mb-2 leading-[1.8]">
              {lang === 'my' ? w.myT : w.enT}
            </h4>
